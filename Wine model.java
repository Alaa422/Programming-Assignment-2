...
public class Wine {
  public static void main(String[] args) {
    ...
    **/
    ...
    String path_training = "s3://mybucketwineproject/TrainingDataset.csv";
    String path_validation = "s3://mybucketwineproject/ValidationDataset.csv";
    ...
    **/  
	...
	// ---------------------------------------- Save Model ---------------------------------------- //
			...
			model.save(sc.sc(), "s3://mybucketwineproject/LogisticRegressionModel/");
